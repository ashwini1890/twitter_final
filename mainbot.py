...
while True:
    user = api.get_user('ashwinisharma36')
    api.update_profile(name=f'ashwini sharma|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : ashwini sharma|{follower_count(user)} Followers')
